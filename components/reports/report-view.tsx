...
export default function ReportView({ report, studyLogs, grades, subjects }: ReportViewProps) {
        ...
        <CardContent>
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-700">
                {Object.keys(report.subject_study_time).length === 0 ? (
                  "아직 등록된 학습 기록이 없습니다. 학습 기록을 추가하여 더 정확한 분석을 받아보세요."
                ) : (
                  <>
            ...
            <div>
              ...
              <p className="text-gray-700">
                {grades.length === 0
                  ? "아직 등록된 성적이 없습니다. 성적을 추가하여 더 정확한 분석을 받아보세요."
                  : `전체 과목의 평균 성적은 ${report.average_grade.toFixed(1)}%입니다.`}
              </p>
            </div>

            <div>
              <h3 className="font-semibold mb-2">학습 제안</h3>
              <ul className="list-disc pl-5 text-gray-700 space-y-1">
                <li>정기적인 학습 계획을 세우고 꾸준히 실천하세요.</li>
                <li>부족한 과목에 더 많은 시간을 투자하는 것이 좋습니다.</li>
                <li>학습 내용을 복습하고 문제를 풀어보며 이해도를 높이세요.</li>
                <li>어려운 개념은 선생님이나 친구들에게 질문하여 해결하세요.</li>
              </ul>
            </div>
          </div>
        </CardContent>
